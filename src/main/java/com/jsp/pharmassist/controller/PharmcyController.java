...
public class PharmcyController {
	...
	public ResponseEntity<ResponseStructure<PharmcyResponse>> findAdminById(@PathVariable String pharmacyId) {
		PharmcyResponse response = pharmcyService.findPharmacyById(pharmacyId);	
